...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UBPGDIOAgent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UBPGDIOAgent_importDLL, "importDLL" }, // 791074192
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UBPGDIOAgent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_Public_BPGDIOAgent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_Public_BPGDIOAgent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBPGDIOAgent, UBPGDIOAgent::StaticClass, TEXT("UBPGDIOAgent"), &Z_Registration_Info_UClass_UBPGDIOAgent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBPGDIOAgent), 4055110188U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_Public_BPGDIOAgent_h_1496744771(TEXT("/Script/HPathDebugger"),
		Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_Public_BPGDIOAgent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_Public_BPGDIOAgent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
