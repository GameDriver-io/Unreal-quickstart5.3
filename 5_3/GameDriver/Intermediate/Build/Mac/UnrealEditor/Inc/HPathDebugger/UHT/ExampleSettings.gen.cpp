...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UExampleSettings_Statics::NewProp_bTest = { "bTest", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UExampleSettings), &Z_Construct_UClass_UExampleSettings_Statics::NewProp_bTest_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UExampleSettings_Statics::NewProp_bTest_MetaData), Z_Construct_UClass_UExampleSettings_Statics::NewProp_bTest_MetaData) };
	...
	struct Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_ExampleSettings_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_ExampleSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UExampleSettings, UExampleSettings::StaticClass, TEXT("UExampleSettings"), &Z_Registration_Info_UClass_UExampleSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UExampleSettings), 1248614519U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_ExampleSettings_h_2968843744(TEXT("/Script/HPathDebugger"),
		Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_ExampleSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Builds_5_3_GameDriver_HostProject_Plugins_GameDriver_Source_Editor_ExampleSettings_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
